...
@section('page_title')
  Member Profile | <a href="/sysAdmin/profiles"  class="btn btn-default btn-sm"><i class="fa fa-reply"></i></a>
@endsection
            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                        ...
                        <a href="sysAdmin/profiles/profile_slug/edit" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                        <br />-->
