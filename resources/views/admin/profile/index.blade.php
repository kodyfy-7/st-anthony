                                ...
                                <div class="well profile_view">
                                    <div class="col-sm-12">
                                        <div class="left col-xs-7">
                                            ...
                                            <ul class="list-unstyled">
                                                <li><i class="fa fa-phone"></i> Phone: {{ $profile->mobile_number }}</li>
                                                <li><i class="fa fa-map"></i> Address: {{ $profile->home_address }}</li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-xs-12 bottom text-center">
                                        <div class="col-xs-12 col-sm-6 emphasis">
                                            <a href="/sysAdmin/profiles/{{$profile->profile_slug}}/edit" class="btn btn-warning btn-xs"><i class="fa fa-user">
                                            </i> <i class="fa fa-edit"></i> Edit Profile</a>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 emphasis">
                                            <a href="/sysAdmin/profiles/{{$profile->profile_slug}}" class="btn btn-success btn-xs"><i class="fa fa-user">
