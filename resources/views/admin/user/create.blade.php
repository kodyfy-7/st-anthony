...
@section('page_title')
  Administrators | <a href="/sysAdmin/administrators"  class="btn btn-default"><i class="fa fa-reply"></i></a>
@endsection
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                {!! Form::open(['route' => 'administrators.store', 'method' =>'POST', 'enctype' => 'multipart/form-data']) !!}
