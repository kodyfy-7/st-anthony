...
@section('page_title')
  Parish Council | <a href="/sysAdmin/councils"  class="btn btn-default"><i class="fa fa-reply"></i></a>
@endsection
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit {{$council->user->profile->full_name}} council detail</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                {!! Form::open(['route' => 'councils.store', 'method' =>'POST', 'enctype' => 'multipart/form-data']) !!}
                  @include('admin.council.form')
                  <div class="col-md-12">
