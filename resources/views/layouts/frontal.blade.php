...
<body>
  ...
  <footer id="footer">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <p>
                ...
                <strong>Email:</strong> info@stanthony.com<br>
              </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>{{ config('app.name', 'St. Anthony') }}</span></strong>. All Rights Reserved
      </div>
      <div class="credits">

        Developed by <a href="https://kodyfy.herokuapp.com/">Kodyfy</a>
      </div>
    </div>
  </footer><!-- End Footer -->
