...
<div id="wizard" class="form_wizard wizard_horizontal">
  ...
  <div id="step-2">
            ...
            <div class="form-group">
                ...
                <label for=""><strong>Select groups you belong in church</strong></label>
                <div class="checkbox">
                ...
                <div class="checkbox">
                    ...
                    @foreach ($groups2 as $group2)
                        <label for=""><input type="checkbox" name="groups[]" value="{{$group2->id}}" id="">{{$group2->group_title}}</label>
                    @endforeach
                </div>
                <div class="checkbox">
                    <label for=""><strong>Liturgical Groups:</strong></label>
                    @foreach ($groups3 as $group3)
                        <label for=""><input type="checkbox" name="groups[]" value="{{$group3->id}}" id="">{{$group3->group_title}}</label>
                    @endforeach
                </div>
                <div class="checkbox">
                    <label for=""><strong>Basic Christian Communities:</strong></label>
                    @foreach ($groups4 as $group4)
                        <label for=""><input type="checkbox" name="groups[]" value="{{$group4->id}}" id="">{{$group4->group_title}}</label>
                    @endforeach
                </div>
            </div>
            <!--<div class="form-group">
